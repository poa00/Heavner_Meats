...
class CustomerSearch
{
	...
	static Call()
	{
		...
		LV.SetFont("cBlack")
		customerGui.Add("Button", "x1050 y194 w380 h90 BackgroundBlack", "Confirm Selection")
		customerGui.Add("Button", "x1050 y+20 w380 h90 BackgroundBlack", "Confirm Selection")
		customerGui.Add("Button", "x1050 y+20 w380 h90 BackgroundBlack", "Confirm Selection")
		ButtonConfirmSelection := customerGui.Add("Button", "x1050 y+20 w380 h90 BackgroundBlack", "Confirm Selection")
		...
		clickConfirm(*)
		{
			...
			customerSearch.Profile := customers[Integer(cID)]
...
importCustomer(LV, searchVal?)
{
	...
	for k, v in customers
	{
		if v.Has("full_name")
		{
			...
			try {
				LV.Add(, v["full_name"], v["email"], v["billing_street"], v["customerID"])
			} catch as e {
				continue
			}
		}
