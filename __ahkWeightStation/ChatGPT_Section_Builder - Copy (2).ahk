...
"
(
    this is just instruction for how to answer. after you confirm your understanding of the instructions, ill provide my request.
    I need you to write an ahkv2 script. I will provide a request in a separate message.  autohotkey v2 is new and constantly changing, Below are built-in functions marked (; v1) you may not use that need to replace with below methods labeled with ``; v2``.  when sourcing your answer, before you provide it, search through your answer and anything that matchs code marked``; v1`` replace with code marked `` ; v2``
)"
...
sectionEdit := MainGui.Add("Edit",  "x10 r2", "Selection_Title")
sectionEdit.WidthP := 0.9
pasteSection := MainGui.Add("Edit", "y+10 r4", "paste_code_here")
pasteSection.WidthP := 0.9
firstButton := MainGui.Add("Button", "y+10 ", "Add another section")
firstButton.WidthP := 0.9
editSection2 := MainGui.Add("Edit", "y+10 r3", "act as a developer. I will provide context code in a separate message. Context will start with ``[[  AHK or PY or other code Section START ]]`` and end with ``[[  AHK or PY code Section END ]]``. I need your answer to be creative and complete code, if I provide you code to make changes, and there's a better way to do anything, please refactor or rename variables or do anything at your discretion. I always need the best code, even if it alters what I provided. Does that make sense?")
...
finalCopyEdit.OnEvent("Focus", FocusCopy)
...
addSection()
{
    ...
    sectionEdit.Value := "Selection_Title"
    pasteSection.value := "pasteSection"
}
