from ..API_events.pewee_sql_handler import update_customer
import logging
...
def fix_env(runtime_dll_path, main_pyfile, environ, divider):
        
    if runtime_dll_path.exists() or (main_pyfile != "main.py"):
        environ["PYTHONNET_PYDLL"] = str(runtime_dll_path.resolve())
